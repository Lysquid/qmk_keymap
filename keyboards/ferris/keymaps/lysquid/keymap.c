...
[NUM] = LAYOUT(
    ...
    OC_LALT,    OC_LGUI,    OC_LSFT,    OC_LCTL,    KC_SPC,     KC_TAB,     KF_4,       KF_5,       KF_6,       KF_0,
    KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F11,     KF_1,       KF_2,       KF_3,       KF_DOT,
                                        _______,    _______,    _______,    _______
),

[MOS] = LAYOUT(
    XXXXXXX,    OS_BTN2,    OS_BTN3,    OS_BTN1,    KC_BRIU,    DF(DEF2),   MS_WHLL,    MS_UP,      MS_WHLR,    XXXXXXX,
    XXXXXXX,    MS_BTN2,    MS_BTN3,    MS_BTN1,    KC_BRID,    DF(DEF),    MS_LEFT,    MS_DOWN,    MS_RGHT,    XXXXXXX,
    OC_LALT,    OC_LGUI,    OC_LSFT,    OC_LCTL,    QK_RBT,     QK_BOOT,    MS_WHLU,    MS_WHLD,    XXXXXXX,    XXXXXXX,
                                        _______,    MS_ACL0,    _______,    _______
),
